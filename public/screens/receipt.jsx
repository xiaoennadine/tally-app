...
function ReceiptScreen({ data, onClose, onSaved }) {
  ...
  // step: capture | parsing | review | summary | error
...
function SummaryStep({ receipt, wallet, userId, payerId, perPerson, grandTotal, groupId, busy, onBack, onConfirm }) {
        ...
        <div style={{ textAlign: 'center', marginBottom: 14 }}>
          ...
          {group && (
            <div style={{
              ...
              borderRadius: 100, fontSize: 11, fontWeight: 600, marginTop: 6,
            }}>
