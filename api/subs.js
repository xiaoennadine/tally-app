...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    const sub = {
      ...
      // Added fields to support Clearbit/Google real company logos
    ...
    // If updating an existing subscription, you might want to handle it here if your 
    // frontend sends the ID in the POST request (depending on your setup).
    // Otherwise, this currently pushes a brand new sub.
